...
public class StatusActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accessibilityStatus.setText(SharedServiceResources.serviceConnected ? R.string.accessibilityStatusConnected : R.string.accessibilityStatusNotConnected);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case REQUEST_DRAWING_RIGHTS: {
                if (Settings.canDrawOverlays(SharedServiceResources.mas)) PointerInitializer.initializePointer();
